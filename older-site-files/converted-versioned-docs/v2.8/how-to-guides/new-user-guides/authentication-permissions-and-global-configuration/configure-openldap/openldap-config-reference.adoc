...
____
Before you proceed with the configuration, please familiarize yourself with the concepts of link:../authentication-config/authentication-config.adoc#external-authentication-configuration-and-principal-users[External Authentication Configuration and Principal Users].
____
...
If you are in doubt about the correct values to enter in the user/group Search Base configuration fields, consult your LDAP administrator or refer to the section link:../../../../how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/configure-active-directory.adoc#annex-identify-search-base-and-schema-using-ldapsearch[Identify Search Base and Schema using ldapsearch] in the Active Directory authentication documentation.+++<figcaption>+++OpenLDAP Server Parameters+++</figcaption>+++
