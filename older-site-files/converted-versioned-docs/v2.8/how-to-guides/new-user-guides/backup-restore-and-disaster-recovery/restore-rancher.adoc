...
. Follow these xref:../backup-restore-and-disaster-recovery/migrate-rancher-to-new-cluster.adoc[instructions] to install the rancher-backup Helm chart on the existing cluster and restore the previous state.
 .. Omit Step 3.
