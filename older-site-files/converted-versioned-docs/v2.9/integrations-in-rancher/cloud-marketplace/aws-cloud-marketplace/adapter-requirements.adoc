...
Follow the xref:../../../getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-amazon-eks.adoc[Rancher docs] to create an EKS cluster. When you get to the link:../../../getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-amazon-eks.adoc#8-install-the-rancher-helm-chart[final step to install Rancher], *stop and return to this page*. This cluster will need to meet the following requirements:
...
In addition to the options specified to install Rancher in the link:../../../getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-amazon-eks.adoc#8-install-the-rancher-helm-chart[Rancher docs], you will also need to enable extra metrics.
