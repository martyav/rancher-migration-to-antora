...
. (Optional) Add any labels and annotations.
. Click *Create*.
...
If you need to update immediately, you can link:../helm-charts-in-rancher/helm-charts-in-rancher.adoc#refresh-chart-repositories[perform a manual refresh].
...
* To enhance logging information, link:../../../troubleshooting/other-troubleshooting-tips/logging.adoc#kubernetes-install[enable the debug option] while deploying Rancher.
