...
有关直接编辑 Prometheus 自定义资源（对高级用例可能有帮助）的更多信息，请参阅xref:advanced-configuration/prometheus.adoc[此页面]。
...
对于一些高级用例，你可能需要直接配置 Alertmanager。有关详细信息，请参阅xref:advanced-configuration/alertmanager.adoc[此页面]。
...
有关直接编辑 Alertmanager 自定义资源（对高级用例可能有帮助）的更多信息，请参阅xref:advanced-configuration/alertmanager.adoc[此页面]。
