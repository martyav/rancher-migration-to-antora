 ...
 ** 此选项仅适用于 Docker 安装。请知悉，以下安装命令取代了 xref:../../../pages-for-subheaders/rancher-on-a-single-node-with-docker.adoc[Docker 安装链接]中的示例：
 ...
 ** CNI 网络插件必须是 link:../../../faq/container-network-interface-providers.adoc#flannel[Flannel]
* 导入包含使用 ARM64 架构的节点的集群
 ** Kubernetes 集群必须为 1.12 或更高版本

如需了解如何配置集群选项，请参见xref:../../../reference-guides/cluster-configuration/rancher-server-configuration/rke1-cluster-configuration.adoc[集群选项]。
