...
| Google GCE
| 为每个节点添加静态路由：https://cloud.google.com/vpc/docs/using-routes#addingroute[添加静态路由]。

| Azure VM
| 创建一个路由表：https://docs.microsoft.com/en-us/azure/virtual-network/virtual-networks-udr-overview#user-defined[自定义路由：用户定义]。
|===
