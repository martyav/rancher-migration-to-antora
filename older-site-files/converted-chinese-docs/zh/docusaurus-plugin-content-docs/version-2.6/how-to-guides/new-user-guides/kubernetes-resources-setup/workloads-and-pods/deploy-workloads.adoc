...
. 点击**添加端口**进入端口映射，这让你可以访问集群内外的应用程序。如需更多信息，请参阅 link:../../../../pages-for-subheaders/workloads-and-pods.adoc#services[Service]。
. 配置其余选项：
 ** *环境变量*
+
 ...
 ** 集群必须使用 https://github.com/kubernetes/website/blob/release-1.18/content/en/docs/concepts/cluster-administration/cloud-providers.md#aws[AWS 云提供商]选项。有关启用此选项的更多信息，请参阅xref:../../launch-kubernetes-with-rancher/use-new-nodes-in-an-infra-provider/create-an-amazon-ec2-cluster.adoc[创建 AWS EC2 集群]或xref:../../../../pages-for-subheaders/use-existing-nodes.adoc[创建自定义集群]。
