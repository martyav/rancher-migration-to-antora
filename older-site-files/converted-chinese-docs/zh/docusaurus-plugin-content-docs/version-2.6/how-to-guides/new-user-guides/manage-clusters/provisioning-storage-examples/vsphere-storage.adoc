...
为了在 vSphere 中动态调配存储，必须启用 vSphere 提供商。有关更多信息，请参阅xref:../../../new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-cloud-providers/configure-out-of-tree-vsphere.adoc[树外 vSphere] 和xref:../../../new-user-guides/kubernetes-clusters-in-rancher-setup/set-up-cloud-providers/configure-in-tree-vsphere.adoc[树内 vSphere]。

=== 先决条件

为了在 xref:../../../../pages-for-subheaders/launch-kubernetes-with-rancher.adoc[Rancher Kubernetes Engine (RKE)] 集群中配置 vSphere 卷，https://rancher.com/docs/rke/latest/en/config-options/cloud-providers/vsphere[vSphere cloud provider] 必须在xref:../../../../reference-guides/cluster-configuration/rancher-server-configuration/rke1-cluster-configuration.adoc[集群选项]中显式启用。
