...
如果你没有在节点模板上定义https://kubernetes.io/docs/concepts/configuration/taint-and-toleration/[污点]，则可以为每个节点池添加污点。相比在节点模板上添加污点，在节点池上添加污点的好处在于，你可以替换节点模板，而不必担心污点是否在节点模板中。
...
如果你找不到想要的主机驱动，你可以在 Rancher 的link:../how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/about-provisioning-drivers/manage-node-drivers.md#激活停用主机驱动[内置主机驱动]中查看并激活它，也可以link:../how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/about-provisioning-drivers/manage-node-drivers.adoc#添加自定义主机驱动[添加自定义主机驱动]。
...
对于 RKE2 集群模板，请参阅link:../how-to-guides/new-user-guides/manage-clusters/manage-cluster-templates.adoc#rke2-集群模板[此页面]了解更多信息。
====
...
在xref:../how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/checklist-for-production-ready-clusters/recommended-cluster-architecture.adoc[推荐的集群架构]中，我们概述了每个角色集群应该有多少节点：
