...
有关 Fleet 如何运作的信息，请参阅link:./fleet-gitops-at-scale/architecture[此处]。
...
有关对具有 Windows 节点的集群的支持的详细信息，请参阅link:./fleet-gitops-at-scale/windows-support[此页面]。

== GitHub 仓库

Fleet Helm charts 可在https://github.com/rancher/fleet/releases/tag/v0.3.10[此处]获取。

== 在代理后使用 Fleet

有关在代理后面使用 Fleet 的详细信息，请参阅link:./fleet-gitops-at-scale/use-fleet-behind-a-proxy[此页面]。
