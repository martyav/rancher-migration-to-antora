...
* nginx-ingress-controller（RKE1 和 RKE2 默认）：https://kubernetes.github.io/ingress-nginx/user-guide/tls/#default-tls-version-and-ciphers[默认的 TLS 版本和密码]。
* traefik（K3s 默认）：https://doc.traefik.io/traefik/https/tls/#tls-options[TLS 选项]。
