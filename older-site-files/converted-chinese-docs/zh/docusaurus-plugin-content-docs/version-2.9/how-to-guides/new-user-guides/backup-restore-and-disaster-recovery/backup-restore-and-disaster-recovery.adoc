...
使用 backup-restore-operator 执行恢复后，Fleet 中会出现一个已知问题：用于 clientSecretName 和 helmSecretName 的密文不包含在 Fleet 的 Git 仓库中。请参见link:../../../integrations-in-rancher/fleet/overview.adoc#故障排除[此处]获得解决方法。
====
