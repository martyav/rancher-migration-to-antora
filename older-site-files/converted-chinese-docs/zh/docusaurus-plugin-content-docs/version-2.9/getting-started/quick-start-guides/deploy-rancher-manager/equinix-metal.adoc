...
* 如需了解所有端口要求，请参见 xref:../../../how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/node-requirements-for-rancher-managed-clusters.adoc[Docker 安装]。
* 根据我们的xref:../../installation-and-upgrade/installation-requirements/installation-requirements.adoc[要求]配置主机。
====
