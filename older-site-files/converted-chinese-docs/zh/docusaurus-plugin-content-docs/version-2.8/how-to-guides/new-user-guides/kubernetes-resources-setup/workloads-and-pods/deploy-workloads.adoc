 ...
 ** 集群必须使用 https://kubernetes.io/docs/concepts/cluster-administration/cloud-providers/#aws[AWS 云提供商]选项。有关启用此选项的更多信息，请参阅xref:../../launch-kubernetes-with-rancher/use-new-nodes-in-an-infra-provider/create-an-amazon-ec2-cluster.adoc[创建 AWS EC2 集群]或xref:../../../../pages-for-subheaders/use-existing-nodes.adoc[创建自定义集群]。
