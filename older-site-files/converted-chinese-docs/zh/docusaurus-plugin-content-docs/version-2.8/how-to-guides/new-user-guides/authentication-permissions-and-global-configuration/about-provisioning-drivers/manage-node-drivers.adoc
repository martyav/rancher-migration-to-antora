...
* 分配了xref:../manage-role-based-access-control-rbac/global-permissions.adoc[管理主机驱动角色]的link:../manage-role-based-access-control-rbac/global-permissions.adoc#自定义全局权限[自定义全局权限]。
====
