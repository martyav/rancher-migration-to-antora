...
* xref:configure-ms-adfs-for-rancher.adoc[1. 在 Microsoft AD FS 中配置 Rancher]
* xref:configure-rancher-for-ms-adfs.adoc[2. 在 Rancher 中配置 Microsoft AD FS]
...
=== xref:configure-ms-adfs-for-rancher.adoc[后续操作：在 Microsoft AD FS 中配置 Rancher]
