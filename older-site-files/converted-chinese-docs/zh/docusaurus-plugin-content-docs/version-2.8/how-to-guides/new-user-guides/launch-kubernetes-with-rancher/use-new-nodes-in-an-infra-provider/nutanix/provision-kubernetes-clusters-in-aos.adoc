...
. 找到 Rancher 的内置 Nutanix link:../../../authentication-permissions-and-global-configuration/about-provisioning-drivers/manage-node-drivers.adoc#激活停用主机驱动[主机驱动并激活它]。
...
有关配置 Nutanix AOS 节点模板的详细信息，请参阅 xref:../../../../../reference-guides/cluster-configuration/downstream-cluster-configuration/node-template-configuration/nutanix.adoc[Nutanix AOS 节点模板配置参考]。

有关在 Rancher 中配置 RKE Kubernetes 集群的详细信息，请参阅xref:../../../../../reference-guides/cluster-configuration/rancher-server-configuration/rke1-cluster-configuration.adoc[集群配置参考]。
...
为 Nutanix AOS 创建link:../../../../../pages-for-subheaders/use-new-nodes-in-an-infra-provider.adoc#节点模板[节点模板]会允许 Rancher 在 Nutanix AOS 中配置新节点。其他集群可以复用节点模板。
...
. 单击**添加模板**。
. 单击 *Nutanix*。
. 填写 Nutanix AOS 的节点模板。有关填写表格的帮助，请参阅 Nutanix AOS 节点模板xref:../../../../../reference-guides/cluster-configuration/downstream-cluster-configuration/node-template-configuration/nutanix.adoc[配置参考]。
. 单击**创建**。
