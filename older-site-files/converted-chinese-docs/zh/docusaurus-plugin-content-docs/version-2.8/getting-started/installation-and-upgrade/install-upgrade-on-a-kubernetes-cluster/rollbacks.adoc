...
. 按照xref:../../../how-to-guides/new-user-guides/backup-restore-and-disaster-recovery/migrate-rancher-to-new-cluster.adoc[说明]在现有集群上安装 rancher-backup Helm Chart 并恢复之前的状态。
 .. 省略步骤 3。
 .. 执行到步骤 4 时，在要回滚到的 local 集群上安装 Rancher 2.6.x 版本。
...
====
+
如果 Rancher Backups 应用不可见，你需要到 *Apps* 的 Charts 页面中安装应用。详情请参见link:../../../pages-for-subheaders/helm-charts-in-rancher.adoc#charts[此处]。
+
====
