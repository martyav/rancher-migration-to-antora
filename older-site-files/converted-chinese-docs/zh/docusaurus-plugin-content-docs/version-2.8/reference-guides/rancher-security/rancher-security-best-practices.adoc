...
如果你需要此类功能，请将 7 层防火墙与link:../../how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/authentication-config.adoc#外部认证与本地认证[外部认证]结合使用。
