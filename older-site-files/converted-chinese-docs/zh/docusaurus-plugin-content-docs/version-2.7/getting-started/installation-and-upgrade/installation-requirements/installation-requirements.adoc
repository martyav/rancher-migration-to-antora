...
如果在加固的 Kubernetes 集群上安装 Rancher，请参阅link:../../../how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/psa-config-templates.adoc#豁免必须的-rancher-命名空间[豁免必须的 Rancher 命名空间]部分了解更详细的要求。
