...
按照xref:update-rancher-certificate.adoc[步骤]更新 xref:../install-upgrade-on-a-kubernetes-cluster/install-upgrade-on-a-kubernetes-cluster.adoc[Rancher 高可用 Kubernetes 安装]中的 Ingress，或从默认自签名证书切换到自定义证书。
