= 在 Rancher 中设置负载均衡器和 Ingress Controller
...
* link:../how-to-guides/new-user-guides/kubernetes-resources-setup/load-balancer-and-ingress-controller/layer-4-and-layer-7-load-balancing.adoc#四层负载均衡支持[支持 Layer-4 负载均衡]
* link:../how-to-guides/new-user-guides/kubernetes-resources-setup/load-balancer-and-ingress-controller/layer-4-and-layer-7-load-balancing.adoc#七层负载均衡支持[支持 Layer-7 负载均衡]
...
* 有关如何在 Rancher 中设置 Ingress 的更多信息，请参阅 xref:../how-to-guides/new-user-guides/kubernetes-resources-setup/load-balancer-and-ingress-controller/add-ingresses.adoc[Ingress]。
