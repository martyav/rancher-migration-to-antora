= K3s Self-Assessment Guide - CIS Benchmark v1.23 - K8s v1.24

This document is a companion to the xref:../../../../pages-for-subheaders/k3s-hardening-guide.adoc[K3s Hardening Guide], which provides prescriptive guidance on how to harden K3s clusters that are running in production and managed by Rancher. This benchmark guide helps you evaluate the security of a hardened cluster against each control in the CIS Kubernetes Benchmark.
