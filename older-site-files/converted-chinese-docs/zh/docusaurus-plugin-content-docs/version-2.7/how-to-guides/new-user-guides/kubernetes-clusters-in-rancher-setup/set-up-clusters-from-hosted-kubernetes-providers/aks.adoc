...
. 单击**创建**。
. 单击 *Azure*。
. 填写表单。有关填写表格的帮助，请参阅link:../../../../reference-guides/cluster-configuration/rancher-server-configuration/aks-cluster-configuration.adoc#云凭证[配置参考]。
. 单击**创建**。
...
. 在**集群**中，单击**创建**。
. 单击 *Azure AKS*。
. 填写表单。有关填写表格的帮助，请参阅xref:../../../../reference-guides/cluster-configuration/rancher-server-configuration/aks-cluster-configuration.adoc[配置参考]。
. 单击**创建**。
...
有关如何在 Rancher UI 配置 AKS 集群的更多信息，请参阅xref:../../../../reference-guides/cluster-configuration/rancher-server-configuration/aks-cluster-configuration.adoc[配置参考]。
...
AKS 配置者可以在 Rancher 和提供商之间同步 AKS 集群的状态。有关其工作原理的技术说明，请参阅xref:../../../../reference-guides/cluster-configuration/rancher-server-configuration/sync-clusters.adoc[同步]。
