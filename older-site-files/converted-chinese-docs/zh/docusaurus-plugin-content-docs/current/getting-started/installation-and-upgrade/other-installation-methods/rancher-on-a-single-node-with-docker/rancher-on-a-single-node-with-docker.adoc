...
请确保你的节点满足常规的xref:../../installation-requirements/installation-requirements.adoc[安装要求]。

== 1. 配置 Linux 主机

按照xref:../../installation-requirements/installation-requirements.adoc[要求]配置一个 Linux 主机，用于运行 Rancher Server。
...
* 完成离线安装。参见 xref:../air-gapped-helm-cli-install/air-gapped-helm-cli-install.adoc[离线：Docker 安装]。
...
如需了解常见问题及故障排除提示，请参见xref:certificate-troubleshooting.adoc[本页]。
...
* 创建 Kubernetes 集群：xref:../../../../how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/kubernetes-clusters-in-rancher-setup.adoc[配置 Kubernetes 集群]。
