...
要查看指向外部监控 UI（包括 Grafana 仪表板）的链接，你至少需要一个 link:../../../integrations-in-rancher/monitoring-and-alerting/rbac-for-monitoring.adoc#具有-rancher-权限的用户[project-member 角色]。
