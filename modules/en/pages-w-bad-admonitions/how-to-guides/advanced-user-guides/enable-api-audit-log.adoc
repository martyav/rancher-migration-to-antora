...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/advanced-user-guides/enable-api-audit-log">++++++</link>++++++</head>+++
...
* link:../../reference-guides/single-node-rancher-in-docker/advanced-options.md#api-audit-log[Docker Install]
* link:../../getting-started/installation-and-upgrade/installation-references/helm-chart-options.md#api-audit-log[Kubernetes Install]
...
You can enable Rancher's built in log collection and shipping for the cluster to ship the audit and other services logs to a supported collection endpoint. See xref:../../integrations-in-rancher/logging/logging.adoc[Rancher Tools - Logging] for details.
