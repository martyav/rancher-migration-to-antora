...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/reference-guides/backup-restore-configuration/examples">++++++</link>++++++</head>+++
...
This example shows that the AWS credential secret does not have to be provided to create a backup if the nodes running `rancher-backup` have link:backup-configuration.md#iam-permissions-for-ec2-nodes-to-access-s3[these permissions for access to S3.]
...
This example shows that the AWS credential secret does not have to be provided to restore from backup if the nodes running `rancher-backup` have link:backup-configuration.md#iam-permissions-for-ec2-nodes-to-access-s3[these permissions for access to S3.]
