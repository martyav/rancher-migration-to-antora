...
Alternatively, in order to make such changes permanent, these environment variables can be set by link:../../getting-started/installation-and-upgrade/installation-references/helm-chart-options.adoc#setting-extra-environment-variables[using Helm values] instead.
