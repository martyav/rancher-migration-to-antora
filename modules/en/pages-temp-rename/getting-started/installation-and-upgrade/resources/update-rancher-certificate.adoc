...
Select 'Force Update' for the clusters within the link:../../../integrations-in-rancher/fleet/overview.adoc#accessing-fleet-in-the-rancher-ui[Continuous Delivery] view of the Rancher UI to allow the fleet-agent in downstream clusters to successfully connect to Rancher.
