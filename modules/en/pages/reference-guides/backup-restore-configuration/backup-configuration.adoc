...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/reference-guides/backup-restore-configuration/backup-configuration">++++++</link>++++++</head>+++
...
For example Backup custom resources, refer to link:examples.md#backup[this page.]
