...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/reference-guides/rancher-security">++++++</link>++++++</head>++++++<table width="100%">+++<tr style={{verticalAlign: 'top'}}>
