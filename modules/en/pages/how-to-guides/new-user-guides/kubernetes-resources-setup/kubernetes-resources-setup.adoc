...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/kubernetes-resources-setup">++++++</link>++++++</head>+++
...
When deploying a workload, you can deploy from any image. There are a variety of link:workloads-and-pods/workloads-and-pods.md#workload-types[workload types] to choose from which determine how your application should run.
...
* link:load-balancer-and-ingress-controller/layer-4-and-layer-7-load-balancing.md#layer-4-load-balancer[Layer-4 Load Balancers]
* link:load-balancer-and-ingress-controller/layer-4-and-layer-7-load-balancing.md#layer-7-load-balancer[Layer-7 Load Balancers]
