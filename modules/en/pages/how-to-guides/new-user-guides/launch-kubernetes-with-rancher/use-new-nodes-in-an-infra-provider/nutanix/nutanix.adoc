...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/launch-kubernetes-with-rancher/use-new-nodes-in-an-infra-provider/nutanix">++++++</link>++++++</head>+++
...
* link:provision-kubernetes-clusters-in-aos.md#creating-a-nutanix-aos-cluster[Creating a Nutanix Cluster]
