...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/manage-clusters/create-kubernetes-persistent-storage/manage-persistent-storage/about-glusterfs-volumes">++++++</link>++++++</head>+++

:::note

This section only applies to xref:../../../launch-kubernetes-with-rancher/launch-kubernetes-with-rancher.adoc[RKE clusters.]
