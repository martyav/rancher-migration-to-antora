...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/configure-azure-ad">++++++</link>++++++</head>+++
...
+
image::/img/azure-public-client-flows.png[Allow Public Client Flows]
...
. (Optional) In Rancher v2.9.0 and later, you can filter users' group memberships in Azure AD to reduce the amount of log data generated. See steps 4--5 of <<filtering-users-by-azure-ad-auth-group-memberships,Filtering Users by Azure AD Auth Group Memberships>> for full instructions.
. Click *Enable*.
...
image::/img/auth-setup-azure-ad-filter.png[Adding a group membership filter to Azure AD]
