...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/authentication-config/configure-okta-saml">++++++</link>++++++</head>+++
...
____
Before you proceed with the configuration, please familiarise yourself with link:authentication-config.md#external-authentication-configuration-and-principal-users[external authentication configuration and principal users].
____
