...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/about-rke1-templates/manage-rke1-templates">++++++</link>++++++</head>+++
...
You can revise, share, and delete a template if you are an owner of the template. For details on how to become an owner of a template, refer to link:access-or-share-templates.md#sharing-ownership-of-templates[the documentation on sharing template ownership.]
...
. Optional: Share the template with other users or groups by link:access-or-share-templates.md#sharing-templates-with-specific-users-or-groups[adding them as members.] You can also make the template public to share with everyone in the Rancher setup.
...
* New clusters can be link:apply-templates.md#creating-a-cluster-from-an-rke-template[created from the new template and revision.]
