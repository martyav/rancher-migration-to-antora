...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/psa-config-templates">++++++</link>++++++</head>+++
...
* `rancher-restricted`: A heavily restricted configuration that follows current best practices for hardening pods. You must make link:./pod-security-standards.md#rancher-on-psa-restricted-clusters[namespace-level exemptions] for Rancher components.
