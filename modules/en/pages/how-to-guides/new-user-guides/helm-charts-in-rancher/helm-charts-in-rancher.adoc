...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/helm-charts-in-rancher">++++++</link>++++++</head>+++
...
| rancher-sriov^<<sriov-chart-deprecation-and-migration,1>>^
| 100.0.0+up0.1.0
| 100.0.3+up0.1.0
...
. Add the SUSE Edge repository to your cluster by following the steps in <<add-custom-git-repositories,Add Custom Git Repositories>>.
