...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/integrations-in-rancher/istio/cpu-and-memory-allocations">++++++</link>++++++</head>+++
...
. Click *Upgrade* to edit the base components via changes to the values.yaml or add an link:configuration-options/configuration-options.md#overlay-file[overlay file]. For more information about editing the overlay file, see link:cpu-and-memory-allocations.md#editing-the-overlay-file[this section.]
