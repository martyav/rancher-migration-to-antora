...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/integrations-in-rancher/kubernetes-distributions">++++++</link>++++++</head>+++
...
* Standard Rancher management of Kubernetes clusters including all outlined link:../../how-to-guides/new-user-guides/kubernetes-clusters-in-rancher-setup/kubernetes-clusters-in-rancher-setup.md#cluster-management-capabilities-by-cluster-type[cluster management capabilities].
