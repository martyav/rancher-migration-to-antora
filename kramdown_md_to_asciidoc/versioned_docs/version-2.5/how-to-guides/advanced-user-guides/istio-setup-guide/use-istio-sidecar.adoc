...
. From the *Cluster Explorer* click on menu:Workload[Overview.]
. Click *Create.*
. Select *Deployment* from the various workload options.
...
. From the *Cluster Explorer* click on menu:Service Discovery[Services]
. Click *Create*
. Select the type of service you want to create from the various options
. Fill out the form, or *Edit as Yaml*
. Click *Create*
