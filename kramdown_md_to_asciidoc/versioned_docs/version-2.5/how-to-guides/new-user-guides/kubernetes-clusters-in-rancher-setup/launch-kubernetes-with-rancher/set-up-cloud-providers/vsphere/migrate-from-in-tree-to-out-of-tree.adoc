= Migrating vSphere In-tree Volumes to Out-of-tree
:experimental:
...
. Select the *vSphere CPI* chart.
. Fill out the required vCenter details and click *Launch*.
...
. Click *Edit as Form* and then click on "Advanced Options."
. Set the field *Maximum Worker Nodes Unavailable* to count of 1.
