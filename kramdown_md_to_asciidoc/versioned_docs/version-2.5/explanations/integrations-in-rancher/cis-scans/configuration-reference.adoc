...
To configure the custom resources, go to the *Cluster Explorer* in the Rancher UI. In dropdown menu in the top left corner, click menu:Cluster Explorer[CIS Benchmark.]
