...
* link:../../../../integrations-in-rancher/rancher-extensions.adoc#importing-and-installing-extensions-in-an-air-gapped-environment[Importing and installing extensions in an air-gapped environment]
