...
* *Pipelines:* Setting up a xref:../../how-to-guides/advanced-user-guides/manage-projects/ci-cd-pipelines.adoc[pipeline] can help developers deliver new software as quickly and efficiently as possible. Within Rancher, you can configure pipelines for each of your Rancher projects.
