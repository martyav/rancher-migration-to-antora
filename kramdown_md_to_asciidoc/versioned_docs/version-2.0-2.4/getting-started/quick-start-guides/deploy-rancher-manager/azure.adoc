...
See the https://github.com/rancher/quickstart[Quickstart Readme] and the https://github.com/rancher/quickstart/tree/master/rancher/azure#readme[Azure Quickstart Readme] for more information.
Suggestions include:
