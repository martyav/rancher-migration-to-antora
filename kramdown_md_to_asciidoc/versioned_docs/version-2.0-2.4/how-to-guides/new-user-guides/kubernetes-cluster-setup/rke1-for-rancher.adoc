...
For systems without direct internet access, refer to xref:../../../getting-started/installation-and-upgrade/advanced-options/advanced-use-cases/air-gap-helm2/air-gap-helm2.adoc[Air Gap: Kubernetes install.]
...
For tuning your etcd cluster for larger Rancher installations, see the xref:../../../getting-started/installation-and-upgrade/advanced-options/advanced-use-cases/tune-etcd-for-large-installs.adoc[etcd settings guide].
____
...
=== xref:../../../reference-guides/installation-references/helm-chart-options.adoc[Next: Install Rancher]
