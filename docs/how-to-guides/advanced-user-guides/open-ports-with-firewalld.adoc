...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/advanced-user-guides/open-ports-with-firewalld">++++++</link>++++++</head>+++
...
This section describes how to use `firewalld` to apply the link:../../getting-started/installation-and-upgrade/installation-requirements/installation-requirements.md#port-requirements[firewall port rules] for nodes in a high-availability Rancher server cluster.
