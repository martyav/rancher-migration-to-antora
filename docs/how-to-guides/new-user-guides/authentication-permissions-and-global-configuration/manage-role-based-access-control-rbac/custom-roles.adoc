...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/manage-role-based-access-control-rbac/custom-roles">++++++</link>++++++</head>+++
...
* link:global-permissions.md#custom-global-permissions[Custom Global Permissions] with the xref:global-permissions.adoc[Manage Roles] role assigned.
...
* You have set up an link:../authentication-config/authentication-config.md#external-vs-local-authentication[external authentication provider]
