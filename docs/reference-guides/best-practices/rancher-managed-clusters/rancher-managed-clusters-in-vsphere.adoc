...
+++<head>++++++<link rel="canonical" href="https://ranchermanager.docs.rancher.com/reference-guides/best-practices/rancher-managed-clusters/rancher-managed-clusters-in-vsphere">++++++</link>++++++</head>+++
...
image::/img/solution_overview.drawio.svg[Solution Overview]
