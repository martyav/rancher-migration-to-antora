...
____
Before you proceed with the configuration, please familiarize yourself with the concepts of link:../../how-to-guides/advanced-user-guides/authentication-permissions-and-global-configuration/about-authentication/about-authentication.adoc#external-authentication-configuration-and-principal-users[External Authentication Configuration and Principal Users].
____
...
* <<usergroup-schema-configuration,User/group schema configuration>>
...
If you are in doubt about the correct values to enter in the user/group Search Base configuration fields, consult your LDAP administrator or refer to the section link:../../how-to-guides/advanced-user-guides/authentication-permissions-and-global-configuration/about-authentication/authentication-config/configure-active-directory.adoc#annex-identify-search-base-and-schema-using-ldapsearch[Identify Search Base and Schema using ldapsearch] in the Active Directory authentication documentation.+++<figcaption>+++OpenLDAP Server Parameters+++</figcaption>+++
...
If you are unfamiliar with the user/group schema used in the OpenLDAP server, consult your LDAP administrator or refer to the section link:../../how-to-guides/advanced-user-guides/authentication-permissions-and-global-configuration/about-authentication/authentication-config/configure-active-directory.adoc#annex-identify-search-base-and-schema-using-ldapsearch[Identify Search Base and Schema using ldapsearch] in the Active Directory authentication documentation.
