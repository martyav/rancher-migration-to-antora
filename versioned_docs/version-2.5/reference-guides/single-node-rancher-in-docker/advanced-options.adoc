...
* <<running-rancherrancher-and-rancherrancher-agent-on-the-same-node,Running `rancher/rancher` and `rancher/rancher-agent` on the Same Node>>
...
As of Rancher v2.5, privileged access is link:../../getting-started/installation-and-upgrade/other-installation-methods/rancher-on-a-single-node-with-docker/rancher-on-a-single-node-with-docker.adoc#privileged-access-for-rancher-v25[required.]
