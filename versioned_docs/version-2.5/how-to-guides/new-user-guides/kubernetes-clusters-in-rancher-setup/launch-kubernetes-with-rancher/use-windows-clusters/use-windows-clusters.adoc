...
* Enable the GCE cloud provider in the `cluster.yml` by following xref:../set-up-cloud-providers/other-cloud-providers/google-compute-engine.adoc[these steps.]
...
. Go to the cluster that you created and click menu:&#8942;[Edit.]
