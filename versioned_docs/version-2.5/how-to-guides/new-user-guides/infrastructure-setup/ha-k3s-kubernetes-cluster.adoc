...
For an example of one way to set up the MySQL database, refer to this xref:../../../how-to-guides/new-user-guides/infrastructure-setup/mysql-database-in-amazon-rds.adoc[tutorial] for setting up MySQL on Amazon's RDS service.
