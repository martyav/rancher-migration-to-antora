...
. <<4-add-listener-to-nlb-for-tcp-port-80,Add listener to NLB for TCP port 80>>
...
NOTE: Health checks are handled differently based on the Ingress. For details, refer to <<health-check-paths-for-nginx-ingress-and-traefik-ingresses,this section.>>
