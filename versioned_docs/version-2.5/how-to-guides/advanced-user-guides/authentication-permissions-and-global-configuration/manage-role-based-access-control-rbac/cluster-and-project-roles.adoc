...
Cluster and project roles define user authorization inside a cluster or project. You can manage these roles from the menu:Global[Security > Roles] page.
...
. Go to the member you want to give the role to. Click the menu:&#8942;[View in API.]
...
. From the *Global* view, select menu:Security[Roles] from the main menu. Select either the *Cluster* or *Project* tab.
. Find the custom or individual role that you want to use as default. Then edit the role by selecting menu:&#8942;[Edit].
