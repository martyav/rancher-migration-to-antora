...
The cluster can be imported into Rancher from the Rancher UI by clicking menu:Global/Add Cluster[Other Cluster.] Then run the provided kubectl command on the server/master node.
