...
* link:../../../reference-guides/single-node-rancher-in-docker/advanced-options.adoc#custom-ca-certificate[Docker install Custom CA certificate options]
* link:../../../reference-guides/installation-references/helm-chart-options.adoc#additional-trusted-cas[Kubernetes install options for Additional Trusted CAs]
