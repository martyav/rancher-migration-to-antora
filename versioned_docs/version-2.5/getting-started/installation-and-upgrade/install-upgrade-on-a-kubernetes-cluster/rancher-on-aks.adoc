...
* Your subscription has sufficient quota for at least 2 vCPUs. For details on Rancher server resource requirements, refer to link:../installation-requirements/installation-requirements.adoc#rke-and-hosted-kubernetes[this section]
