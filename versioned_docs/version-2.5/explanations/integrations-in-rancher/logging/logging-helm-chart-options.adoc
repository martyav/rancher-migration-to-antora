...
To enable hosted Kubernetes providers as additional logging sources, go to menu:Cluster Explorer[Logging > Chart Options] and select the *Enable enhanced cloud provider logging* option.
