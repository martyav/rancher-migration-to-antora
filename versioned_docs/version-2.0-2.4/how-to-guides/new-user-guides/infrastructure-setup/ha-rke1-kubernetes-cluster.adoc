 ...
 ** NOTE: When installing Rancher with Helm in Azure, use the L7 load balancer to avoid networking issues. Please refer https://docs.microsoft.com/en-us/azure/load-balancer/components#limitations[here] for more information on Azure load balancer limitations.
