= Load Balancer and Ingress Controller Setup within Rancher
...
* When using ingresses in a project, you can program the ingress hostname to an external DNS by setting up a Global DNS entry, see xref:../../helm-charts-in-rancher/globaldns.adoc[Global DNS].
