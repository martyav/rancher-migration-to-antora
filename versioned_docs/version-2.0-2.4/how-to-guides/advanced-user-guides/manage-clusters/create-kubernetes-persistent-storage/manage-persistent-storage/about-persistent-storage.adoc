...
Each Rancher project contains a list of PVCs that you've created, available from menu:Resources[Workloads > Volumes.] (In versions before v2.3.0, the PVCs are in the *Volumes* tab.) You can reuse these PVCs when creating deployments in the future.
