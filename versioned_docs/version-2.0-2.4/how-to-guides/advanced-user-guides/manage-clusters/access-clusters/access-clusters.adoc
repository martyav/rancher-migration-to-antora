...
For information on how to set up an authentication system, see xref:../../authentication-permissions-and-global-configuration/about-authentication/about-authentication.adoc[this section.]
