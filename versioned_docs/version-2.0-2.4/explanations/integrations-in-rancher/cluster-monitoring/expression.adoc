...
The PromQL expressions in this doc can be used to configure xref:../cluster-alerts/cluster-alerts.adoc[alerts.]

____
Before expressions can be used in alerts, monitoring must be enabled. For more information, refer to the documentation on enabling monitoring xref:cluster-monitoring.adoc[at the cluster level] or xref:./project-monitoring.adoc[at the project level.]
____

For more information about querying Prometheus, refer to the official https://prometheus.io/docs/prometheus/latest/querying/basics/[Prometheus documentation.]
