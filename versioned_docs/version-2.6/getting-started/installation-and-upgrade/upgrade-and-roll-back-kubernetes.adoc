...
As of Rancher v2.4.0, there is a https://github.com/rancher/rancher/issues/25478[known issue] in which the Rancher UI doesn't show state of etcd and controlplane as drained, even though they are being drained.
====
