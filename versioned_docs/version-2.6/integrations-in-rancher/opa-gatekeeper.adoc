...
Tab Rancher v2.6.5+::
+
1. In the upper left corner, click **☰ > Cluster Management**. 1. In the **Clusters** page, go to the cluster where you want to enable OPA Gatekeeper and click **Explore**. 1. In the left navigation bar, click **Apps**. 1. Click **Charts** and click **OPA Gatekeeper**. 1. Click **Install**. 

Tab Rancher before v2.6.5::
+
1. In the upper left corner, click **☰ > Cluster Management**. 1. In the **Clusters** page, go to the cluster where you want to enable OPA Gatekeeper and click **Explore**. 1. In the left navigation bar, click **Apps & Marketplace**. 1. Click **Charts** and click **OPA Gatekeeper**. 1. Click **Install**.
====
