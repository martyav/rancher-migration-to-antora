...
It's important to follow K8s and etcd best practices when deploying your nodes, including disabling swap, double checking you have full network connectivity between all machines in the cluster, using unique hostnames, MAC addresses, and product_uuids for every node, checking that all correct ports are opened, and deploying with ssd backed etcd. More details can be found in the https://kubernetes.io/docs/setup/production-environment/tools/kubeadm/install-kubeadm/#before-you-begin[kubernetes docs] and etcd's performance op guide. Since details about etcd differ by version, see the https://etcd.io/docs/v3.5/op-guide/performance/[official etcd v3.5 documentation] if you're running Kubernetes v1.22 and later, or see the https://etcd.io/docs/v3.5/op-guide/performance/[official etcd v3.4 documentation] if you are running an earlier Kubernetes version.
