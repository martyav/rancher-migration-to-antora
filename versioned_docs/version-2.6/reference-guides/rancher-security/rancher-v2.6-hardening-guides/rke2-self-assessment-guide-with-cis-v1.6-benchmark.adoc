...
https://releases.rancher.com/documents/security/2.6/Rancher_RKE2_v2-6_CIS_v1-6_Benchmark_Assessment.pdf[Click here to download a PDF version of this document].

==== Overview

This document is a companion to the xref:rke2-hardening-guide-with-cis-v1.6-benchmark.adoc[Rancher v2.6 RKE2 security hardening guide]. The hardening guide provides prescriptive guidance for hardening a production installation of Rancher with RKE2 provisioned clusters, and this benchmark guide is meant to help you evaluate the level of security of the hardened cluster against each control in the benchmark.
