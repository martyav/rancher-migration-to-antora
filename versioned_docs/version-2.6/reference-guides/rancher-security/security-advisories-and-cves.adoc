...
| 31 May 2023
| Rancher https://github.com/rancher/rancher/releases/tag/v2.6.13[v2.6.13]
...
| https://github.com/rancher/rancher/security/advisories/GHSA-7m72-mh5r-6j3r[CVE-2022-43759]
| An issue was discovered in Rancher versions from 2.5.0 up to and including 2.5.16 and from 2.6.0 up to and including 2.6.9, where an authorization logic flaw allows privilege escalation via project role template binding (PRTB) and `-promoted` roles.
| 24 January 2023
| Rancher https://github.com/rancher/rancher/releases/tag/v2.6.10[v2.6.10] and https://github.com/rancher/rancher/releases/tag/v2.5.17[v2.5.17]
