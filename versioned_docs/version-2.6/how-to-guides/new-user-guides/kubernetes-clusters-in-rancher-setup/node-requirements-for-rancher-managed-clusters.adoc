...
Hardware recommendations for etcd clusters in production differ by etcd version. For more information, see the https://etcd.io/docs/v3.5/op-guide/hardware/[official etcd v3.5 documentation] if you're running Kubernetes v1.22 and later. Otherwise, see the https://etcd.io/docs/v3.4/op-guide/hardware/[official etcd v3.4 documentation].
